...
class Fixed {
    class Eggs {
        static let Intro: [Data.Eggs.Intro] = [
            .init(icon: "questionmark.app.dashed", text: "Fine tune the effects randomly 🎹 (Reverb, Delay, Distortion and EQ) (The obstacle changes their values)"),
